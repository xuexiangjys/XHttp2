 ...
 * <p>
 * 在Retrofit中，我们可以通过@Headers来配置，如：<br>
 * <p>
 * {@code @Headers("Cache-Control: public, max-age=3600)}
 * {@code @GET("merchants/{shopId}/icon")}
 * {@code Observable<ShopIconEntity> getShopIcon(@Path("shopId") long shopId);}
 * </p>
